...
alert('Hello ' + firstName + ' nice to meet you! My name is Biniam.');
...
//SEVENTH QUESTION
var city2 = ['MIAMI', 'SEATTLE', 'DALLAS', 'HOUSTON', 'OAKLAND', 'BROOKLYN'];
...
while (tries <= 6) {
  ...
  if (tries === 6) {
    alert('Sorry ' + firstName + ' you ran out of tries.');
    break;
  }

}
if (score >= 5) {
  alert('So, ' + firstName + ' you got ' + score + ' out of 7 on my questions. Great Job!'); // opens last window stating this.
}
else {
  alert('So, ' + firstName + ' you only got ' + score + ' out of 7 on my questions. Try harder next time!'); // opens last window stating this.
}
